...
| Increment Hit Count | HTTP Request | PATCH `hit_count + 1` on matching cache row |
| AI Agent (Classify Intent) | AI Agent | Gemini 2.0 Flash — classifies into `escalate`, `action`, or `rag` |
